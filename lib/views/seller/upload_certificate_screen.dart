...
class _UploadCertificateScreenState
    extends State<UploadCertificateScreen> {
  ...
  Future<void> _submitCert() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Certificate submitted for review!'),
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Upload your halal certification documents to get your products approved for sale.',
                      style: TextStyle(
